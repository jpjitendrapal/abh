<div id="main-ct">
    ...
    <div class="slide-text">
        <h3>Breaking News: भारतीयों ने तैयार की ओस से जल संचयन की तकनीक, इलाहाबाद के डॉक्टरों ने शुरू की ‘द 21 डॉक्टर्स’
            मुहिम</h3>
    </div>
    <div class="row">
                        ...
                        <ul class="bxslider-2">
                            <li class="slider-content">
                                <div class="row">
                                    ...
                                    <div class="col-xs-6">
                                        <span>
                                                    <div class="event-name">Devi Ahilya Bai Jayanti</div>
                                                    <div class="event-detail">We are gathering in orai for jayanti divas</div>
                                                </span>
                                    </div>
                                    <div class="date">
                                        <div>03 Sep - 06 Sep</div>
    ...
    <div class="row">
        <div class="col-xs-12 team margin-bottom-20 bxslider">
            ...
            <ul class="bxslider-5">
                ...
                <li>
                    <a href="https://www.facebook.com/harish.pal.1612" target="_blank">
                        <div class="  member text-center">
    ...
    <div class="row hidden">
        <div class="col-xs-12 team margin-bottom-20">
            ...
            <a href="https://www.facebook.com/Pnsinghpalpramukhji/" target="_blank">
                <div class="col-xs-6 col-sm-3 member">
                    <img class="member-img img-responsive" src="./abhnews/src/img/team/prem.jpg" />
                    <div class="text-center member-name">Prem Narayan Singh Pal</div>
                </div>
            </a>
            ...
            <a href="https://www.facebook.com/harish.pal.1612" target="_blank">
                <div class="col-xs-6 col-sm-3 member">
                    <img class="member-img img-responsive" src="./abhnews/src/img/team/harish.png" />
                    <div class="text-center member-name">Harish Pal</div>
                </div>
            </a>
            <a href="https://www.facebook.com/Pnsinghpalpramukhji/" target="_blank">
                <div class="col-xs-6 col-sm-3 member">
